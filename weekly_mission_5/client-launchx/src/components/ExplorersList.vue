	...
	<div class="list row">
		...
		<div class="col-md-6">
			<div v-if="currentExplorer">
				<h4>Explorer</h4>
				<div>
					<br /><label><strong>Nombre:</strong></label> {{ currentExplorer.name }} <br /><label
						><strong>Username:</strong></label
					>
					{{ currentExplorer.username }} <br /><label><strong>Mission:</strong></label> {{ currentExplorer.mission }}
				</div>
